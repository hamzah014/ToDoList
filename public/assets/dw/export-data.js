...
(function (a) {
    ...
    k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
        var f = a.isSafari,
            ...
            r = a.dataURLtoBlob = function (a) {
                if ((a = a.replace(/filename=.*;/, "").match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < a.length && d.atob && d.ArrayBuffer && d.Uint8Array && d.Blob && l.createObjectURL) {
                    var f = d.atob(a[3]),
                        m = new d.ArrayBuffer(f.length);
                    m = new d.Uint8Array(m);
                    for (var b = 0; b < m.length; ++b) m[b] = f.charCodeAt(b);
                    a = new d.Blob([m], {
                        type: a[1]
                    });
        ...
        a = a.downloadURL = function (a, l) {
            ...
            if ("string" ===
                ...
                if (f && "string" === typeof a && 0 === a.indexOf("data:application/pdf") || m || 2E6 < a.length)
                    if (a = r(a) || "", !a) throw Error("Failed to convert to blob");
                if ("undefined" !== typeof b.download) b.href = a, b.download = l, p.body.appendChild(b), b.click(), p.body.removeChild(b);
                else try {
    ...
    k(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function (a, f, d, p, l, r, m) {
        function k(a, n) {
            var c = g.navigator,
                b = -1 < c.userAgent.indexOf("WebKit") && 0 > c.userAgent.indexOf("Chrome"),
                d = g.URL || g.webkitURL || g;
            try {
                if (c.msSaveOrOpenBlob && g.MSBlobBuilder) {
                    var t = new g.MSBlobBuilder;
                    t.append(a);
                    return t.getBlob("image/svg+xml")
                }
                if (!b) return d.createObjectURL(new g.Blob(["\ufeff" +
                    a
                ], {
                    type: n
                }))
        ...
        f.prototype.setUpKeyToAxis = function () {
            b.arearange && (b.arearange.prototype.keyToAxis = {
                low: "y",
                high: "y"
            });
            b.gantt && (b.gantt.prototype.keyToAxis = {
                start: "x",
                end: "x"
            })
        };
        f.prototype.getDataRows = function (c) {
            var n = this.hasParallelCoordinates,
                y = this.time,
                b = this.options.exporting && this.options.exporting.csv || {},
                d = this.xAxis,
                t = {},
                f = [],
                m = [],
            ...
            var l = g.categoryHeader,
                ...
                w = function (q, e, d) {
                    if (b.columnHeaderFormatter) {
                        var n = b.columnHeaderFormatter(q, e, d);
                        if (!1 !== n) return n
                    }
                    return q ? q instanceof a ? q.options.title && q.options.title.text || (q.dateTime ? M : l) : c ? {
                        columnTitle: 1 < d ? e : q.name,
                ...
                H = function (a, c, e) {
                    ...
                    c.forEach(function (c) {
                        var b =
                            (a.keyToAxis && a.keyToAxis[c] || c) + "Axis";
                        b = L(e) ? a.chart[b][e] : a[b];
                        q[c] = b && b.categories || [];
                        d[c] = b && b.dateTime
                    });
                    return {
                ...
                r = function (a, c) {
                    ...
                    }).length && c && !c.categories && !a.keyToAxis ? a.pointArrayMap && a.pointArrayMap.filter(function (a) {
                        return "x" === a
            ...
            this.series.forEach(function (a) {
                ...
                if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
                    ...
                    for (l = 0; l < f;) z = w(a, q[l], q.length), p.push(z.columnTitle || z), c && m.push(z.topLevelColumnTitle || z), l++;
                    var A = {
                        chart: a.chart,
                    ...
                    a.options.data.forEach(function (c, d) {
                        n && (B = H(a, q, d));
                        var w = {
                            series: A
                        };
                        a.pointClass.prototype.applyOptions.apply(w,
                            [c]);
                        c = w.x;
                        var h = a.data[d] && a.data[d].name;
                        l = 0;
                        if (!e || "name" === a.exportKey || !n && e && e.hasNames && h) c = h;
                        g && (g[c] && (c += "|" + d), g[c] = !0);
                        t[c] || (t[c] = [], t[c].xValues = []);
                        t[c].x = w.x;
                        t[c].name = h;
                        for (t[c].xValues[k] = w.x; l < f;) d = q[l], h = w[d], t[c][x + l] = v(B.categoryMap[d][h], B.dateTimeValueAxisMap[d] ? y.dateFormat(b.dateFormat, h) : null, h), l++
                    });
                    x += l
                }
            });
            for (e in t) Object.hasOwnProperty.call(t, e) && f.push(t[e]);
            var e = c ? [m, p] : [p];
            for (x = h.length; x--;) {
                var A = h[x][0];
                var D = h[x][1];
                ...
                g = w(k);
                e[0].splice(D, 0, g);
                c && e[1] && e[1].splice(D, 0, g);
                f.forEach(function (a) {
                    var c = a.name;
                    k && !J(c) && (k.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), c = y.dateFormat(b.dateFormat, a.x)) : c = k.categories ? v(k.names[a.x], k.categories[a.x], a.x) : a.x);
                    a.splice(D, 0, c)
                })
            }
            e = e.concat(f);
        ...
        f.prototype.getCSV = function (a) {
            var c = "",
                ...
                f = v(b.decimalPoint, "," !== b.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."),
                l = v(b.itemDelimiter, "," === f ? ";" : ","),
                g = b.lineDelimiter;
            d.forEach(function (a, b) {
                for (var n, y = a.length; y--;) n = a[y], "string" === typeof n && (n = '"' + n + '"'), "number" === typeof n && "." !== f && (n = n.toString().replace(".", f)), a[y] = n;
                c += a.join(l);
                b < d.length - 1 && (c += g)
            });
            return c
        ...
        f.prototype.getTableAST = function (a) {
            ...
            var g = l ? a.shift() : null,
                ...
                m = function (a, c, b, d) {
                    var h = v(d, "");
                    c = "text" + (c ? " " + c : "");
                    "number" === typeof h ? (h = h.toString(), "," === f && (h = h.replace(".", f)), c = "number") : d || (c = "empty");
                    b = F({
                        "class": c
                    }, b);
                    return {
            ...
            !1 !== d.exporting.tableCaption && b.push({
                tagName: "caption",
                attributes: {
            ...
            for (var p = 0, r = a.length; p < r; ++p) a[p].length > c && (c = a[p].length);
            b.push(function (a, c, b) {
                var f = [],
                    h = 0;
                b = b || c && c.length;
                var n = 0,
                ...
                if (e) {
                    for (e = []; h < b; ++h) {
                        var g = a[h];
                        var k = a[h + 1];
                        g === k ? ++n : n ? (e.push(m("th", "highcharts-table-topheading", {
                            scope: "col",
                            colspan: n + 1
                        }, g)), n = 0) : (g === c[h] ? d.exporting.useRowspanHeaders ? (k = 2, delete c[h]) : (k = 1, c[h] = "") : k = 1, g = m("th", "highcharts-table-topheading", {
                            scope: "col"
                ...
                if (c) {
                    e = [];
                    h = 0;
                    for (b = c.length; h < b; ++h) "undefined" !== typeof c[h] && e.push(m("th", null, {
                        scope: "col"
                    }, c[h]));
                    f.push({
                        tagName: "tr",
            ...
            }(g, k, Math.max(c, k.length)));
            var u = [];
            a.forEach(function (a) {
                for (var b = [], d = 0; d < c; d++) b.push(m(d ? "td" : "th", null, d ? {} : {
                    scope: "row"
                }, a[d]));
                u.push({
                    tagName: "tr",
        ...
        f.prototype.toggleDataTable = function (a) {
            ...
            this.dataTableDiv && (this.dataTableDiv.style.display = a ? "block" : "none", a && (this.dataTableDiv.innerHTML = d.emptyHTML, (new d([this.getTableAST()])).addToDOM(this.dataTableDiv), C(this, "afterViewData", this.dataTableDiv)));
            ...
            b = this.options.lang;
            u && u.menuItemDefinitions && b && b.viewData && b.hideData && c && a && (a = a[c.indexOf("viewData")]) && d.setElementHTML(a,
        ...
        b.map && (b.map.prototype.exportKey = "name");
        b.mapbubble && (b.mapbubble.prototype.exportKey =
            "name");
        b.treemap && (b.treemap.prototype.exportKey = "name")
    });
