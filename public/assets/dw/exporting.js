            ...
            t = function () {
                ...
                a.prototype.setButtonText = function () {
                    var d = this.chart,
                        ...
                        k = b && b.buttons && b.buttons.contextButton.menuItems;
                    d = d.options.lang;
        ...
        var l = a.doc,
            ...
            J = {
                ajax: function (a) {
                    ...
                    b.headers["Content-Type"] || e.setRequestHeader("Content-Type",
                        a[b.dataType] || a.text);
        ...
        (function (e) {
            function t(a) {
                ...
                if (!1 !==
                    ...
                    c.styledMode || (f["stroke-linecap"] = "round",
                        f.fill = w(f.fill, "#ffffff"), f.stroke = w(f.stroke, "none"));
                    var p = d.button(b.text, 0, 0, D, f, l, C).addClass(a.className).attr({
            ...
            function U(c, d, e, y, g, B, n) {
                var f = this,
                    ...
                    h = f[p];
                if (!h) {
                    f.exportContextMenu = f[p] = h = E("div", {
                        className: c
                    }, {
                        position: "absolute",
                        zIndex: 1E3,
                    ...
                    d.forEach(function (c) {
                        "string" ===
                        typeof c && (c = f.options.exporting.menuItemDefinitions[c]);
                        if (Q(c, !0)) {
                            var b = void 0;
            ...
            function Z(a) {
                ...
                e = c.exporting.sourceWidth || c.chart.width || /px$/.test(e) &&
                    parseInt(e, 10) || (c.isGantt ? 800 : 600);
                ...
                this.axes.forEach(function (a) {
                    var c = P(f.axes, function (c) {
                        ...
                        d = b.userMin;
                    b = b.userMax;
                    c && ("undefined" !== typeof d && d !== c.min || "undefined" !== typeof b && b !== c.max) && c.setExtremes(d,
                        b, !0, !1)
                });
                g = f.getChartHTML();
                G(this, "getSVG", {
            ...
            function fa() {
                ...
                g.compose(a).navigation.addUpdate(function (c,
                    b) {
                    a.isDirtyExporting = !0;
            ...
            var O = [],
                da = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/,
            ...
            e.compose = function (a, b) {
                k.compose(b); - 1 === O.indexOf(a) && (O.push(a), b = a.prototype, b.afterPrint = z, b.exportChart = W, b.inlineStyles = ba, b.print = ha, b.sanitizeSVG = ja, b.getChartHTML = X, b.getSVG = Z, b.getSVGForExport = aa, b.getFilename = Y, b.moveContainers = ea, b.beforePrint = H, b.contextMenu =
                    U, b.addButton = t, b.destroyExport = V, b.renderExporting = ia, b.callbacks.push(T), x(a, "init", fa), d.isSafari && d.win.matchMedia("print").addListener(function (a) {
