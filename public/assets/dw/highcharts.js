...
(function (Z, M) {
    ...
    M(a, "Core/Renderer/SVG/SVGLabel.js",
    ...
    M(a, "Core/Renderer/SVG/Symbols.js",
        [a["Core/Utilities.js"]],
        function (a) {
    ...
    M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"],
        ...
        a = function () {
            ...
            a.prototype.renderTick = function (b, d, a) {
                var c = this.ticks;
                if (!this.isLinked || b >= this.min && b <= this.max || this.grid && this.grid.isColumn) c[b] || (c[b] = new H(this, b)), a && c[b].isNew && c[b].render(d, !0,
                    -1), c[b].render(d)
            };
    ...
    M(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"],
        ...
        a = function () {
            ...
            a.prototype.defaultFormatter = function (b) {
                ...
                d.push(b.tooltipFooterHeaderFormatter(a[0],
                    !0));
                return d
            };
            a.prototype.destroy = function () {
                ...
                Q(this, "pan", {
                    ...
                    a.forEach(function (a) {
                        if (a.options.panningEnabled && !a.options.isInternal) {
                            ...
                            a.panningState = q;
                            a.isOrdinal || (m = p - k, 0 < m && (E += m, k = p), m = E - r, 0 < m && (E = r, k -= m), a.series.length && k !== n.min && E !== n.max && k >= p && E <= r && (a.setExtremes(k, E, !1,
                                !1, {
                                    trigger: "pan"
        ...
        a = function () {
            ...
            a.prototype.translate = function () {
                ...
                for (w = 0; w < k; w++) {
                    ...
                    x.plotY = void 0;
                    O(J) && (u = h.translate(J, !1, !0, !1, !0), "undefined" !== typeof u && (x.plotY = r(u,
                        -1E5, 1E5)));
            ...
            a.prototype.addPoint = function (a, b, c, d, e) {
                ...
                this.pointClass.prototype.applyOptions.apply(n,
                    [a]);
                var r = n.x;
                var t = k.length;
            ...
            a.prototype.update = function (a, b) {
                ...
                if (q && this.points) {
                    ...
                    this.points.forEach(function (a) {
                        a && a.series && (a.resolveColor(), Object.keys(p).length && a.destroyElements(p),
                            !1 === x.showInLegend && a.legendItem && d.legend.destroyItem(a))
                    }, this)
                }
                c.initialType = g;
                d.linkSeries();
