! function (e) {
    ...
    function t(i, a) {
        return this instanceof t ? (e.isPlainObject(i) ? a = i : (a = a || {}, a.alias = i), this.el = void 0, this.opts = e.extend(!0, {}, this.defaults, a), this.maskset = void 0, this.noMasksCache = a && void 0 !== a.definitions, this.userOptions = a || {}, this.events = {}, this.dataAttribute = "data-inputmask", this.isRTL = this.opts.numericInput, void n(this.opts.alias, a, this.opts)) : new t(i, a)
    }

    function n(t, i, a) {
        var o = a.aliases[t];
        return o ? (o.alias && n(o.alias, void 0, a), e.extend(!0, a, o), e.extend(!0, a, i), !0) : (null === a.mask && (a.mask = t), !1)
    }
    ...
    function a(n, i, o) {
        function u(e, t, n) {
            ...
            var i, a, r, s = [],
                l = 0,
                c = p();
            W = void 0 !== q ? q.maxLength : void 0, W === -1 && (W = void 0);
            do e === !0 && d().validPositions[l] ? (r = d().validPositions[l], a = r.match, i = r.locator.slice(), s.push(n === !0 ? r.input : n === !1 ? a.nativeDef : j(l, a))) : (r = m(l, i, l - 1), a = r.match, i = r.locator.slice(), (o.jitMasking === !1 || l < c || "number" == typeof o.jitMasking && isFinite(o.jitMasking) && o.jitMasking > l) && s.push(n === !1 ? a.nativeDef : j(l, a))), l++; while ((void 0 === W || l < W) && (null !== a.fn || "" !== a.def) || t > l);
            return "" === s[s.length - 1] && s.pop(), d().maskLength = l + 1, s
        }
        ...
        function p(e, t, n) {
            ...
            for (var r in o) {
                var s = parseInt(r);
                o[s] && (t || null !== o[s].match.fn) && (s <= e && (i = s), s >= e && (a = s))
            }
        ...
        function v(t, n, i, a) {
            ...
            var s, l = t,
                ...
                u = !1;
            for (d().p = t, s = n - 1; s >= l; s--) void 0 !== d().validPositions[s] && (i !== !0 && (!d().validPositions[s].match.optionality && r(s) || o.canClearPosition(d(), s, p(), a, o) === !1) || delete d().validPositions[s]);
            for (f(!0), s = l + 1; s <= p();) {
                for (; void 0 !== d().validPositions[l];) l++;
                if (s < l && (s = l + 1), void 0 === d().validPositions[s] && A(s)) s++;
                else {
                    var v = m(s);
                    u === !1 && c[l] && c[l].match.def === v.match.def ? (d().validPositions[l] = e.extend(!0, {}, c[l]), d().validPositions[l].input = v.input, delete d().validPositions[s], s++) : g(l, v.match.def) ? _(l, v.input || j(s), !0) !== !1 && (delete d().validPositions[s], s++, u = !0) : A(s) || (s++, l--), l++
                }
            }
            f(!0)
        }
        ...
        function h(e, t) {
            for (var n, i = e, a = p(), r = d().validPositions[a] || y(0)[0], s = void 0 !== r.alternation ? r.locator[r.alternation].toString().split(",") : [], l = 0; l < i.length && (n = i[l], !(n.match && (o.greedy && n.match.optionalQuantifier !== !0 || (n.match.optionality === !1 || n.match.newBlockMarker === !1) && n.match.optionalQuantifier !== !0) && (void 0 === r.alternation || r.alternation !== n.alternation || void 0 !== n.locator[r.alternation] && w(n.locator[r.alternation].toString().split(","), s))) || t === !0 && (null !== n.match.fn || /[0-9a-bA-Z]/.test(n.match.def))); l++);
            return n
        }
        ...
        function y(t, n, i) {
                ...
                function c(r, s, f) {
                    function h(t, n) {
                        ...
                        return i || e.each(n.matches, function (e, a) {
                            if (a.isQuantifier === !0 && (i = h(t, n.matches[e - 1]))) return !1
                        }), i
                    }
                    ...
                    if (u === t && void 0 === r.matches) return p.push({
                        match: r,
                        locator: s.reverse(),
                        cd: m
                    }), !0;
                    if (void 0 !== r.matches) {
                        if (r.isGroup && f !== r) {
                            if (r = c(n.matches[e.inArray(r, n.matches) + 1], s)) return !0
                        } else if (r.isOptional) {
                            var y = r;
                            if (r = a(r, i, s, f)) {
                                if (l = p[p.length - 1].match, !h(l, y)) return !0;
                                v = !0, u = t
                            }
                            ...
                            if (_ === -1 || "string" == typeof _) {
                                ...
                                if ("string" == typeof _) O = _.split(",");
                                    ...
                                    for (A = 0; A < P.matches.length; A++) O.push(A);
                                for (var S = 0; S < O.length; S++) {
                                    if (A = parseInt(O[S]), p = [], i = k(u, A, w) || M.slice(), r = c(P.matches[A] || n.matches[A], [A].concat(s), f) || r, r !== !0 && void 0 !== r && O[O.length - 1] < P.matches.length) {
                                        var j = e.inArray(r, n.matches) + 1;
                                        n.matches.length > j && (r = c(n.matches[j], [j].concat(s.slice(1, s.length)), f), r && (O.push(j.toString()), e.each(p, function (e, t) {
                                ...
                                "string" == typeof _ && (E = e.map(E, function (t, n) {
                                    if (isFinite(n)) {
                                        var i, a = t.alternation,
                                            o = t.locator[a].toString().split(",");
                                        t.locator[a] = void 0, t.alternation = void 0;
                                        for (var r = 0; r < o.length; r++) i = e.inArray(o[r], O) !== -1, i && (void 0 !== t.locator[a] ? (t.locator[a] += ",", t.locator[a] += o[r]) : t.locator[a] = parseInt(o[r]), t.alternation = a);
                                        if (void 0 !== t.locator[a]) return t
                                    }
                                })), p = C.concat(E), u = t, v = p.length > 0, i = M.slice()
                            } else r = c(P.matches[_] || n.matches[_], [_].concat(s), f);
                            if (r) return !0
                            ...
                            for (var B = r, F = i.length > 0 ? i.shift() : 0; F < (isNaN(B.quantifier.max) ? F + 1 : B.quantifier.max) && u <= t; F++) {
                                ...
                                if (r = c(N, [F].concat(s), N)) {
                                    if (l = p[p.length - 1].match, l.optionalQuantifier = F > B.quantifier.min - 1, h(l, N)) {
            ...
            function r(t) {
                var n = [];
                return e.isArray(t) || (t = [t]), t.length > 0 && (void 0 === t[0].alternation ? (n = h(t.slice()).locator.slice(), 0 === n.length && (n = t[0].locator.slice())) : e.each(t, function (e, t) {
                    if ("" !== t.def)
            ...
            if (t > -1) {
                if (void 0 === n) {
                    for (var k, g = t - 1; void 0 === (k = d().validPositions[g] || d().tests[g]) && g > -1;) g--;
                    void 0 !== k && g > -1 && (f = r(k), m = f.join(""), u = g)
                }
                if (d().tests[t] && d().tests[t][0].cd === m) return s(d().tests[t]);
        ...
        function P(e) {
            return void 0 !== d().buffer && e !== !0 || (d().buffer = u(!0, p(), !0)), d().buffer
        }

        function E(e, t, n) {
            var i;
            if (e === !0) f(), e = 0, t = n.length;
            else
                for (i = e; i < t; i++) delete d().validPositions[i];
            for (i = e; i < t; i++) f(!0), n[i] !== o.skipOptionalPartCharacter && _(i, n[i], !0, !0)
        }
        ...
        function _(n, i, a, r, s) {
            ...
            function c(t, i, a) {
                ...
                return e.each(y(t), function (c, u) {
                    for (var h = u.match, m = i ? 1 : 0, k = "", g = h.cardinality; g > m; g--) k += O(t - (g - 1));
                    if (i && (k += i), P(!0), s = null != h.fn ? h.fn.test(k, d(), t, a, o, l(n)) : (i === h.def || i === o.skipOptionalPartCharacter) && "" !== h.def && {
                        ...
                        if (void 0 !== s.remove && (e.isArray(s.remove) || (s.remove = [s.remove]), e.each(s.remove.sort(function (e, t) {
                            ...
                            if (a = !0, E(x === !0 ? x : x.start, x.end, A), void 0 === s.pos && void 0 === s.c) return s.pos = p(), !1;
                            if (w = void 0 !== s.pos ? s.pos : t, w !== t) return s = e.extend(s, _(w, y, !0, r)), !1
                        } else if (s !== !0 && void 0 !== s.pos && s.pos !== t && (w = s.pos, E(t, w, P().slice()), w !== t)) return s = e.extend(s, _(w, y, !0)), !1;
                        return (s === !0 || void 0 !== s.pos || void 0 !== s.c) && (c > 0 && f(!0), b(w, e.extend({}, u, {
                            input: C(y, h, w)
                        }), r, l(n)) || (s = !1), !1)
                    }
                }), s
            ...
            function u(t, n, i) {
                var a, s, l, c, u, v, h, m, k = e.extend(!0, {}, d().validPositions),
                    g = !1,
                    b = p();
                for (c = d().validPositions[b]; b >= 0; b--)
                    if (l = d().validPositions[b], l && void 0 !== l.alternation) {
                        if (a = b, s = d().validPositions[a].alternation, c.locator[l.alternation] !== l.locator[l.alternation]) break;
                        c = l
                    } if (void 0 !== s) {
                    m = parseInt(a);
                    ...
                    e.each(y(m, C ? C.locator : void 0, m - 1), function (a, l) {
                        ...
                        for (var c = 0; c < h.length; c++) {
                            ...
                            if (P < h[c] && (void 0 === l.na || e.inArray(h[c], l.na.split(",")) === -1)) {
                                ...
                                for (d().validPositions[m].locator[s] = parseInt(h[c]), null == l.match.fn ? (E.input !== l.match.def && (w = !0, E.generatedInput !== !0 && y.push(E.input)), C++, d().validPositions[m].generatedInput = !/[0-9a-bA-Z]/.test(l.match.def), d().validPositions[m].input = l.match.def) : d().validPositions[m].input = E.input, u = m + 1; u < p(void 0, !0) + 1; u++) v = d().validPositions[u], v && v.generatedInput !== !0 && /[0-9a-bA-Z]/.test(v.input) ? y.push(v.input) : u < t && b++, delete d().validPositions[u];
                                for (w && y[0] === l.match.def && y.shift(), f(!0), g = !0; y.length > 0;) {
                                    var x = y.shift();
                                    if (x !== o.skipOptionalPartCharacter && !(g = _(p(void 0, !0) + 1, x, !1, r, !0))) break
                                }
                                if (g) {
                                    d().validPositions[m].locator = A;
                                    var M = p(t) + 1;
                                    for (u = m + 1; u < p() + 1; u++) v = d().validPositions[u], (void 0 === v || null == v.match.fn) && u < t + (C - b) && C++;
                                    t += C - b, g = _(t > M ? M : t, n, i, r, !0)
                                }
                                if (g) return !1;
                                f(), d().validPositions = e.extend(!0, {}, k)
                            }
                        }
                    })
                }
                    ...
                    for (var a = i.locator, o = a.length, r = t; r < n; r++)
                        if (void 0 === d().validPositions[r] && !A(r, !0)) {
                            ...
                            e.each(s, function (e, t) {
                                for (var n = 0; n < o && void 0 !== t.locator[n] && w(t.locator[n].toString().split(","), a[n].toString().split(",")); n++) c < n && (c = n, l = t)
                            }), b(r, e.extend({}, l, {
            ...
            function b(t, n, i, a) {
                if (a || o.insertMode && void 0 !== d().validPositions[t] && void 0 === i) {
                    var r, s = e.extend(!0, {}, d().validPositions),
                        l = p(void 0, !0);
                    for (r = t; r <= l; r++) delete d().validPositions[r];
                    ...
                    for (r = c = t; r <= l; r++) {
                        ...
                        if (void 0 !== k)
                            for (var y = c; y < d().maskLength && (null === k.match.fn && v[r] && (v[r].match.optionalQuantifier === !0 || v[r].match.optionality === !0) || null != k.match.fn);) {
                                if (y++, h === !1 && s[y] && s[y].match.def === k.match.def) d().validPositions[y] = e.extend(!0, {}, s[y]), d().validPositions[y].input = k.input, M(y), c = y, u = !0;
                                else if (g(y, k.match.def)) {
                                    var b = _(y, k.input, !0, !0);
                                    u = b !== !1, c = b.caret || b.insert ? p() : y, h = !0
                                } else u = k.generatedInput === !0;
                                if (d().maskLength < m && (d().maskLength = m), u) break
                            }
                        if (!u) break
                    }
                    if (!u) return d().validPositions = e.extend(!0, {}, s), f(!0), !1
            ...
            if (M(S), l(n) && (F(void 0, t.keyCode.DELETE, n), S = d().p), S < d().maskLength && (D = c(S, i, a), (!a || r === !0) && D === !1)) {
                ...
                if (!I || null !== I.match.fn || I.match.def !== i && i !== o.skipOptionalPartCharacter) {
                    if ((o.insertMode || void 0 === d().validPositions[x(S)]) && !A(S, !0)) {
                        ...
                        var L = h(G, !0);
                        L && null === L.match.fn && (L = L.match.placeholder || L.match.def, c(S, L, a), d().validPositions[S].generatedInput = !0);
                        for (var B = S + 1, N = x(S); B <= N; B++)
                            if (D = c(B, i, a), D !== !1) {
                                k(S, void 0 !== D.pos ? D.pos : B), S = B;
                                break
                            }
                    }
                } else D = {
            ...
            return D === !1 && o.keepStatic && !a && s !== !0 && (D = u(S, i, a)), D === !0 && (D = {
                pos: S
            }), e.isFunction(o.postValidation) && D !== !1 && !a && r !== !0 && (D = !!o.postValidation(P(!0), D, o) && D), void 0 === D.pos && (D.pos = S), D === !1 && (f(!0), d().validPositions = e.extend(!0, {}, T)), D
        }

        function A(e, t) {
            var n;
            if (t ? (n = m(e).match, "" === n.def && (n = k(e).match)) : n = k(e).match, null != n.fn) return n.fn;
            if (t !== !0 && e > -1) {
                var i = y(e);
        ...
        function M(e, t) {
            var n, i = e;
            if (i <= 0) return 0;
            for (; --i > 0 && (t === !0 && k(i).match.newBlockMarker !== !0 || t !== !0 && !A(i) && (n = y(i), n.length < 2 || 2 === n.length && "" === n[1].match.def)););
            return i
        }
            ...
            if (a && e.isFunction(o.onBeforeWrite)) {
                ...
                if (s) {
                    if (s.refreshFromBuffer) {
                        ...
                        E(l === !0 ? l : l.start, l.end, s.buffer || n), n = P(!0)
                    }
                    void 0 !== i && (i = void 0 !== s.caret ? s.caret : i)
                }
            }
            t.inputmask._valueSet(n.join("")), void 0 === i || void 0 !== a && "blur" === a.type ? R(t, n, i) : I(t, i), r === !0 && (X = !0, e(t).trigger("input"))
        }
                ...
                if (e > -1 && void 0 === d().validPositions[e]) {
                    ...
                    if (i.length > 1 + ("" === i[i.length - 1].match.def ? 1 : 0))
                        for (var r = 0; r < i.length; r++)
                            if (i[r].match.optionality !== !0 && i[r].match.optionalQuantifier !== !0 && (null === i[r].match.fn || void 0 === n || i[r].match.fn.test(n.match.def, d(), e, !0, o) !== !1) && (a.push(i[r]), null === i[r].match.fn && (n = i[r]), a.length > 1 && /[0-9a-bA-Z]/.test(a[0].match.def))) return o.placeholder.charAt(e % o.placeholder.length)
                }
                return t.def
            }
        ...
        function D(n, i, a, r, s, l) {
            ...
            if (f(), d().p = x(-1), !a)
                if (o.autoUnmask !== !0) {
                    ...
                    y && y.length > 0 && (u.splice(0, y.length * g.length), h = x(h))
                } else h = x(h);
            if (e.each(u, function (t, i) {
                    if (void 0 !== i) {
                        var r = new e.Event("keypress");
                        r.which = i.charCodeAt(0), v += i;
                        var s = p(void 0, !0),
                            l = d().validPositions[s],
                            u = m(s + 1, l ? l.locator.slice() : void 0, s);
                        if (!c() || a || o.autoUnmask) {
                            var g = a ? t : null == u.match.fn && u.match.optionality && s + 1 < d().p ? s + 1 : d().p;
                            k = ee.keypressEvent.call(n, r, !0, !1, a, g), h = g + 1, v = ""
                        } else k = ee.keypressEvent.call(n, r, !0, !1, !0, s + 1);
                        if (!a && e.isFunction(o.onBeforeWrite) && (k = o.onBeforeWrite(r, P(), k.forwardPosition, o), k && k.refreshFromBuffer)) {
                            var y = k.refreshFromBuffer;
                            E(y === !0 ? y : y.start, y.end, k.buffer), f(!0), k.caret && (d().p = k.caret)
                        }
                    }
                }), i) {
                var C = void 0,
                    w = p();
                document.activeElement === n && (s || k) && (C = I(n).begin, s && k === !1 && (C = x(p(C))), k && l !== !0 && (C < w + 1 || w === -1) && (C = o.numericInput && void 0 === k.caret ? M(k.forwardPosition) : k.forwardPosition)), S(n, P(), C, s || new e.Event("checkval"))
            }
        }
        ...
        function T(t) {
            ...
            var n = [],
                i = d().validPositions;
            for (var a in i) i[a].match && null != i[a].match.fn && n.push(i[a].input);
        ...
        function I(e, t, n, i) {
            ...
            if (e.scrollLeft = l > e.scrollWidth ? l : 0, r || o.insertMode !== !1 || t !== n || n++, e.setSelectionRange) e.selectionStart = t, e.selectionEnd = n;
            ...
            } else e.createTextRange && (s = e.createTextRange(), s.collapse(!0), s.moveEnd("character", n), s.moveStart("character", t), s.select());
            R(e, void 0, {
                begin: t,
                end: n
            })
        ...
        function G(t) {
            var n, i, a = P(),
                ...
                r = p(),
                s = {},
                l = d().validPositions[r],
                c = void 0 !== l ? l.locator.slice() : void 0;
            for (n = r + 1; n < a.length; n++) i = m(n, c, n - 1), c = i.locator.slice(), s[n] = e.extend(!0, {}, i);
            var u = l && void 0 !== l.alternation ? l.locator[l.alternation] : void 0;
            for (n = o - 1; n > r && (i = s[n], (i.match.optionality || i.match.optionalQuantifier || u && (u !== s[n].locator[l.alternation] && null != i.match.fn || null === i.match.fn && i.locator[l.alternation] && w(i.locator[l.alternation].toString().split(","), u.toString().split(",")) && "" !== y(n)[0].def)) && a[n] === j(n, i.match)); n--) o--;
            return t ? {
                l: o,
        ...
        function L(e) {
            for (var t = G(), n = e.length - 1; n > t && !A(n); n--);
            ...
            function s() {
                if (o.keepStatic) {
                    for (var t = [], i = p(-1, !0), a = e.extend(!0, {}, d().validPositions), r = d().validPositions[i]; i >= 0; i--) {
                        ...
                        if (s) {
                            if (s.generatedInput !== !0 && /[0-9a-bA-Z]/.test(s.input) && t.push(s.input), delete d().validPositions[i], void 0 !== s.alternation && s.locator[s.alternation] !== r.locator[s.alternation]) break;
                            r = s
                        }
                    }
                    if (i > -1)
                        for (d().p = x(p(-1, !0)); t.length > 0;) {
                            ...
                            l.which = t.pop().charCodeAt(0), ee.keypressEvent.call(n, l, !0, !1, !1, d().p)
                        } else d().validPositions = e.extend(!0, {}, a)
                }
            }
            if ((o.numericInput || z) && (i === t.keyCode.BACKSPACE ? i = t.keyCode.DELETE : i === t.keyCode.DELETE && (i = t.keyCode.BACKSPACE), z)) {
                var l = a.end;
                a.end = a.begin, a.begin = l
            }
            i === t.keyCode.BACKSPACE && (a.end - a.begin < 1 || o.insertMode === !1) ? (a.begin = M(a.begin), void 0 === d().validPositions[a.begin] || d().validPositions[a.begin].input !== o.groupSeparator && d().validPositions[a.begin].input !== o.radixPoint || a.begin--) : i === t.keyCode.DELETE && a.begin === a.end && (a.end = A(a.end, !0) ? a.end + 1 : x(a.end) + 1, void 0 === d().validPositions[a.begin] || d().validPositions[a.begin].input !== o.groupSeparator && d().validPositions[a.begin].input !== o.radixPoint || a.end++), v(a.begin, a.end, !1, r), r !== !0 && s();
            var c = p(a.begin, !0);
        ...
        function N(t) {
            function n(e) {
                ...
                for (var a in r) isNaN(a) && a.indexOf("font") !== -1 && (i.style[a] = r[a]);
                ...
                for (n = 0, o = s.length; n <= o; n++) {
                    if (i.innerHTML += s.charAt(n) || "_", i.offsetWidth >= e) {
                        var c = e - l,
                            u = i.offsetWidth - e;
                        i.innerHTML = s.charAt(n), c -= i.offsetWidth / 3, n = c < u ? n - 1 : n;
                        break
                    }
                    l = i.offsetWidth
                }
            ...
            function i() {
                V.style.position = "absolute", V.style.top = a.top + "px", V.style.left = a.left + "px", V.style.width = parseInt(t.offsetWidth) - parseInt(r.paddingLeft) - parseInt(r.paddingRight) - parseInt(r.borderLeftWidth) - parseInt(r.borderRightWidth) + "px", V.style.height = parseInt(t.offsetHeight) - parseInt(r.paddingTop) - parseInt(r.paddingBottom) - parseInt(r.borderTopWidth) - parseInt(r.borderBottomWidth) + "px", V.style.lineHeight = V.style.height, V.style.zIndex = isNaN(r.zIndex) ? -1 : r.zIndex - 1, V.style.webkitAppearance = "textfield", V.style.mozAppearance = "textfield", V.style.Appearance = "textfield"
            }
            var a = e(t).position(),
                r = (t.ownerDocument.defaultView || window).getComputedStyle(t, null);
            t.parentNode, V = document.createElement("div"), document.body.appendChild(V);
            for (var s in r) isNaN(s) && "cssText" !== s && s.indexOf("webkit") == -1 && (V.style[s] = r[s]);
            t.style.backgroundColor = "transparent", t.style.color = "transparent", t.style.webkitAppearance = "caret", t.style.mozAppearance = "caret", t.style.Appearance = "caret", i(), e(window).on("resize", function (n) {
                ...
                return I(t, n(e.clientX)), ee.clickEvent.call(this, [e])
        ...
        function R(e, t, n) {
            ...
            if (void 0 !== V) {
                t = t || P(), void 0 === n ? n = I(e) : void 0 === n.begin && (n = {
                    begin: n,
                    end: n
                });
                var a = "",
                ...
                function i(t) {
                    ...
                    if (!t.inputmask.__valueGet) {
                        if (n.noValuePatching !== !0) {
                            ...
                            } else document.__lookupGetter__ && t.__lookupGetter__("value") && (s = t.__lookupGetter__("value"), l = t.__lookupSetter__("value"), t.__defineGetter__("value", a), t.__defineSetter__("value", o));
                    ...
                    var r = function (n) {
                        if (void 0 === this.inputmask && "FORM" !== this.nodeName) {
                            ...
                            if ("setvalue" === n.type || !(this.disabled || this.readOnly && !("keydown" === n.type && n.ctrlKey && 67 === n.keyCode || o.tabThrough === !1 && n.keyCode === t.keyCode.TAB))) {
                                switch (n.type) {
                                    case "input":
                                        if (X === !0) return X = !1, n.preventDefault();
                                        break;
                                    case "keydown":
                                        Z = !1, X = !1;
                                        break;
            ...
            ee = {
                keydownEvent: function (n) {
                    ...
                    var a = this,
                        ...
                        s = n.keyCode,
                        c = I(a);
                    if (s === t.keyCode.BACKSPACE || s === t.keyCode.DELETE || l && s === t.keyCode.BACKSPACE_SAFARI || n.ctrlKey && s === t.keyCode.X && !i("cut")) n.preventDefault(), F(a, s, c), S(a, P(!0), d().p, n, a.inputmask._valueGet() !== P().join("")), a.inputmask._valueGet() === b().join("") ? r.trigger("cleared") : B(P()) === !0 && r.trigger("complete");
                    else if (s === t.keyCode.END || s === t.keyCode.PAGE_DOWN) {
                        n.preventDefault();
                        var u = x(p());
                        o.insertMode || u !== d().maskLength || n.shiftKey || u--, I(a, n.shiftKey ? c.begin : u, u, !0)
                    } else s === t.keyCode.HOME && !n.shiftKey || s === t.keyCode.PAGE_UP ? (n.preventDefault(), I(a, 0, n.shiftKey ? c.begin : 0, !0)) : (o.undoOnEscape && s === t.keyCode.ESCAPE || 90 === s && n.ctrlKey) && n.altKey !== !0 ? (D(a, !0, !1, H.split("")), r.trigger("click")) : s !== t.keyCode.INSERT || n.shiftKey || n.ctrlKey ? o.tabThrough === !0 && s === t.keyCode.TAB ? (n.shiftKey === !0 ? (null === k(c.begin).match.fn && (c.begin = x(c.begin)), c.end = M(c.begin, !0), c.begin = M(c.end, !0)) : (c.begin = x(c.begin, !0), c.end = x(c.begin, !0), c.end < d().maskLength && c.end--), c.begin < d().maskLength && (n.preventDefault(), I(a, c.begin, c.end))) : n.shiftKey || o.insertMode === !1 && (s === t.keyCode.RIGHT ? setTimeout(function () {
                        var e = I(a);
                        I(a, e.begin)
                    }, 0) : s === t.keyCode.LEFT && setTimeout(function () {
                        var e = I(a);
                        I(a, z ? e.begin + 1 : e.begin - 1)
                    }, 0)) : (o.insertMode = !o.insertMode, I(a, o.insertMode || c.begin !== d().maskLength ? c.begin : c.begin - 1));
                ...
                keypressEvent: function (n, i, a, r, s) {
                    ...
                    if (!(i === !0 || n.ctrlKey && n.altKey) && (n.ctrlKey || n.metaKey || $)) return u === t.keyCode.ENTER && H !== P().join("") && (H = P().join(""), setTimeout(function () {
                        c.trigger("change")
                    }, 0)), !0;
                    if (u) {
                        ...
                        d().writeOutBuffer = !0;
                        var m = _(v, h, r);
                        if (m !== !1 && (f(!0), p = void 0 !== m.caret ? m.caret : i ? m.pos + 1 : x(m.pos), d().p = p), a !== !1) {
                            var k = this;
                            if (setTimeout(function () {
                                    o.onKeyValidation.call(k, u, m, o)
                                }, 0), d().writeOutBuffer && m !== !1) {
                                var g = P();
                                S(l, g, o.numericInput && void 0 === m.caret ? M(p) : p, n, i !== !0), i !== !0 && setTimeout(function () {
                                    B(g) === !0 && c.trigger("complete")
                                }, 0)
                            }
                        }
                        if (n.preventDefault(), i) return m.forwardPosition = p, m
                    }
                },
                pasteEvent: function (t) {
                    ...
                    if (c === (z ? b().reverse() : b()).slice(0, l.begin).join("") && (c = ""), u === (z ? b().reverse() : b()).slice(l.end).join("") && (u = ""), z && (n = c, c = u, u = n), window.clipboardData && window.clipboardData.getData) s = c + window.clipboardData.getData("Text") + u;
                    else {
                    ...
                    return D(i, !1, !1, z ? d.split("").reverse() : d.toString().split("")), S(i, P(), x(p()), t, H !== P().join("")), B(P()) === !0 && r.trigger("complete"), t.preventDefault()
                },
                inputFallBackEvent: function (n) {
                    ...
                    if (P().join("") !== a) {
                        ...
                        if (a = a.replace(new RegExp("(" + t.escapeRegex(b().join("")) + ")*"), ""), s) {
                            ...
                            if (1 === r.length) {
                                var l = new e.Event("keypress");
                                return l.which = r.charCodeAt(0), ee.keypressEvent.call(i, l, !0, !0, !1, d().validPositions[o.begin - 1] ? o.begin : o.begin - 1), !1
                            }
                        }
                        if (o.begin > a.length && (I(i, a.length), o = I(i)), P().length - a.length !== 1 || a.charAt(o.begin) === P()[o.begin] || a.charAt(o.begin + 1) === P()[o.begin] || A(o.begin)) {
                            for (var c = p() + 1, u = b().join(""); null === a.match(t.escapeRegex(u) + "$");) u = u.slice(1);
                            a = a.replace(u, ""), a = a.split(""), D(i, !0, !1, a, n, o.begin < c), B(P()) === !0 && e(i).trigger("complete")
                        } else n.keyCode = t.keyCode.BACKSPACE, ee.keydownEvent.call(i, n);
                        n.preventDefault()
                    }
                },
                setValueEvent: function (t) {
                    ...
                    D(n, !0, !1, (e.isFunction(o.onBeforeMask) ? o.onBeforeMask(i, o) || i : i).split("")), H = P().join(""), (o.clearMaskOnLostFocus || o.clearIncomplete) && n.inputmask._valueGet() === b().join("") && n.inputmask._valueSet("")
                },
                focusEvent: function (e) {
                    var t = this,
                        n = t.inputmask._valueGet();
                    o.showMaskOnFocus && (!o.showMaskOnHover || o.showMaskOnHover && "" === n) && (t.inputmask._valueGet() !== P().join("") ? S(t, P(), x(p())) : J === !1 && I(t, x(p()))), o.positionCaretOnTab === !0 && ee.clickEvent.apply(t, [e, !0]), H = P().join("")
                },
                mouseleaveEvent: function (e) {
                    var t = this;
                    if (J = !1, o.clearMaskOnLostFocus && document.activeElement !== t) {
                        var n = P().slice(),
                            i = t.inputmask._valueGet();
                        i !== t.getAttribute("placeholder") && "" !== i && (p() === -1 && i === b().join("") ? n = [] : L(n), S(t, n))
                    }
                },
                                ...
                                case "radixFocus":
                                    ...
                                    default:
                                        var s = t.begin,
                                            l = p(s, !0),
                                            c = x(l);
                                        if (s < c) I(a, A(s) || A(s - 1) ? s : x(s));
                                        else {
                                            var u = j(c);
                                            ("" !== u && P()[c] !== u && k(c).match.optionalQuantifier !== !0 || !A(c) && k(c).match.def === u) && (c = x(c)), I(a, c)
                                        }
                            }
                        }
                    }, 0)
                ...
                cutEvent: function (n) {
                    ...
                    s.setData("text", z ? l.reverse().join("") : l.join("")), document.execCommand && document.execCommand("copy"), F(i, t.keyCode.DELETE, o), S(i, P(), d().p, n, H !== P().join("")), i.inputmask._valueGet() === b().join("") && a.trigger("cleared")
                },
                blurEvent: function (t) {
                    ...
                    if (i.inputmask) {
                        ...
                        }, 0), "" !== a && (o.clearMaskOnLostFocus && (p() === -1 && a === b().join("") ? r = [] : L(r)), B(r) === !1 && (setTimeout(function () {
                            n.trigger("incomplete")
                        }, 0), o.clearIncomplete && (f(), r = o.clearMaskOnLostFocus ? [] : b().slice())), S(i, r, void 0, t))
                    }
                },
                mouseenterEvent: function (e) {
                    var t = this;
                    J = !0, document.activeElement !== t && o.showMaskOnHover && t.inputmask._valueGet() !== P().join("") && S(t, P())
                },
                submitEvent: function (e) {
                    H !== P().join("") && U.trigger("change"), o.clearMaskOnLostFocus && p() === -1 && q.inputmask._valueGet && q.inputmask._valueGet() === b().join("") && q.inputmask._valueSet(""), o.removeMaskOnSubmit && (q.inputmask._valueSet(q.inputmask.unmaskedvalue(), !0), setTimeout(function () {
                        S(q, P())
                    }, 0))
                },
        ...
        if (void 0 !== n) switch (n.action) {
            case "isComplete":
                return q = n.el, B(P());
            case "unmaskedvalue":
                return void 0 !== q && void 0 === n.value || (Q = n.value, Q = (e.isFunction(o.onBeforeMask) ? o.onBeforeMask(Q, o) || Q : Q).split(""), D(void 0, !1, !1, z ? Q.reverse() : Q), e.isFunction(o.onBeforeWrite) && o.onBeforeWrite(void 0, P(), 0, o)), T(q);
            case "mask":
                K(q);
                break;
            case "format":
                return Q = (e.isFunction(o.onBeforeMask) ? o.onBeforeMask(n.value, o) || n.value : n.value).split(""), D(void 0, !1, !1, z ? Q.reverse() : Q), e.isFunction(o.onBeforeWrite) && o.onBeforeWrite(void 0, P(), 0, o), n.metadata ? {
            ...
            case "isValid":
                n.value ? (Q = n.value.split(""), D(void 0, !1, !0, z ? Q.reverse() : Q)) : n.value = P().join("");
                for (var te = P(), ne = G(), ie = te.length - 1; ie > ne && !A(ie); ie--);
                return te.splice(ne, ie + 1 - ne), B(te) && n.value === P().join("");
            case "getemptymask":
                return b().join("");
            case "remove":
                if (q) {
                    U = e(q), q.inputmask._valueSet(T(q)), Y.off(q);
                    var ae;
    ...
    return t.prototype = {
        ...
        mask: function (o) {
            function r(t, i, a, o) {
                ...
                r("alias", c), a.alias && n(a.alias, a, i);
                for (s in i) {
                    if (l) {
                        c = void 0;
                        for (u in l)
            ...
            return "string" == typeof o && (o = document.getElementById(o) || document.querySelectorAll(o)), o = o.nodeName ? [o] : o, e.each(o, function (n, o) {
                ...
                void 0 !== c && (void 0 !== o.inputmask && o.inputmask.remove(), o.inputmask = new t, o.inputmask.opts = l, o.inputmask.noMasksCache = s.noMasksCache, o.inputmask.userOptions = e.extend(!0, {}, s.userOptions), o.inputmask.el = o, o.inputmask.maskset = c, e.data(o, "_inputmask_opts", l), a.call(o.inputmask, {
                    action: "mask"
                }))
        ...
        analyseMask: function (t, n) {
            ...
            function o(t) {
                t && t.matches && e.each(t.matches, function (e, i) {
                    var r = t.matches[e + 1];
                    (void 0 === r || void 0 === r.matches || r.isQuantifier === !1) && i && i.isGroup && (i.isGroup = !1, a(i, n.groupmarker.start, 0), i.openGroup !== !0 && a(i, n.groupmarker.end)), o(i)
                })
            }

            function r() {
                if (g.length > 0) {
                    if (d = g[g.length - 1], a(d, c), d.isAlternator) {
                        f = g.pop();
                        for (var e = 0; e < f.matches.length; e++) f.matches[e].isGroup = !1;
                        g.length > 0 ? (d = g[g.length - 1], d.matches.push(f)) : k.matches.push(f)
                    }
                } else a(k, c)
            }
            ...
            function s(e) {
                ...
                for (var i in e.matches) {
                    ...
                    if (e.matches[i].isQuantifier && e.matches[a + 1] && e.matches[a + 1].isGroup) {
                        var o = e.matches[i];
                        e.matches.splice(i, 1), e.matches.splice(a + 1, 0, o)
                    }
            ...
            for (var l, c, u, d, f, p, v, h = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, m = !1, k = new i, g = [], y = []; l = h.exec(t);)
                if (c = l[0], m) r();
                    ...
                    case n.groupmarker.end:
                        if (u = g.pop(), u.openGroup = !1, void 0 !== u)
                            if (g.length > 0) {
                                if (d = g[g.length - 1], d.matches.push(u), d.isAlternator) {
                                    f = g.pop();
                                    for (var b = 0; b < f.matches.length; b++) f.matches[b].isGroup = !1;
                                    g.length > 0 ? (d = g[g.length - 1], d.matches.push(f)) : k.matches.push(f)
                                }
                            } else k.matches.push(u);
                        else r();
                        break;
                    ...
                    case n.quantifiermarker.start:
                        ...
                        if ("*" !== w && "+" !== w || (C = "*" === w ? 0 : 1), P.quantifier = {
                                min: C,
                                max: w
                            }, g.length > 0) {
                            var _ = g[g.length - 1].matches;
                            l = _.pop(), l.isGroup || (v = new i(!0), v.matches.push(l), l = v), _.push(l), _.push(P)
                        } else l = k.matches.pop(), l.isGroup || (v = new i(!0), v.matches.push(l), l = v), k.matches.push(l), k.matches.push(P);
                        break;
                    case n.alternatormarker:
                        g.length > 0 ? (d = g[g.length - 1], p = d.matches.pop()) : p = k.matches.pop(), p.isAlternator ? g.push(p) : (f = new i(!1, !1, !1, !0), f.matches.push(p), g.push(f));
                        break;
                    default:
                        r()
                }
            for (; g.length > 0;) u = g.pop(), k.matches.push(u);
            return k.matches.length > 0 && (o(k), y.push(k)), n.numericInput && s(y[0]), y
        }
